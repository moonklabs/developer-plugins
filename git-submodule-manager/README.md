...
# worktree 생성 (비대화식)
bash git-submodule-manager/skills/worktree-manager/scripts/create.sh my-feature main --yes

# 통합 커밋 (비대화식)
bash git-submodule-manager/skills/worktree-manager/scripts/commit.sh "feat: add feature" --yes

# 통합 푸시 (비대화식)
bash git-submodule-manager/skills/worktree-manager/scripts/push.sh --yes

# 브랜치 전환
bash git-submodule-manager/skills/worktree-manager/scripts/switch.sh feature/my-feature --yes
```
