...
3. 사용자 확인 후 실행:
   ```bash
   bash git-submodule-manager/skills/worktree-manager/scripts/create.sh {feature-name} {base-branch} --yes
   ```
...
3. 사용자 확인 후 실행:
   ```bash
   bash git-submodule-manager/skills/worktree-manager/scripts/commit.sh "{commit-message}" --yes
   ```
...
3. 사용자 확인 후 실행:
   ```bash
   bash git-submodule-manager/skills/worktree-manager/scripts/push.sh [--force] --yes
   ```
...
3. 사용자 확인 후 실행:
   ```bash
   bash git-submodule-manager/skills/worktree-manager/scripts/switch.sh {branch-name} [--create] --yes
   ```
